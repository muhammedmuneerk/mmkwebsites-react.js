...
form.addEventListener('submit', async (e) => {
    ...
    try {
        const response = await fetch('https://formspree.io/f/xbljkajn', {
            method: 'POST',
            body: JSON.stringify({
                ...data,
...
// const services = [
//     { name: 'Custom Web Design', description: 'Tailored website designs that reflect your brand identity and meet your specific needs.', icon: 'palette' },
//     { name: 'Responsive Design', description: 'Websites that look great and function flawlessly on all devices, from desktops to smartphones.', icon: 'smartphone' },
//     { name: 'Maintenance & Support', description: 'Ongoing website maintenance and support to keep your site running smoothly and securely.', icon: 'tool' },
//     { name: 'Domain & Hosting', description: 'Assistance with domain registration and reliable web hosting solutions for your website.', icon: 'server' }
// ];